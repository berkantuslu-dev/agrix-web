...
<meta name="keywords" content="Tanzania agritech, smart farming, sustainable agriculture, farmer support programs, agricultural education, market access, Dar es Salaam agriculture, agricultural innovation, farmer solutions, agri analytics, agribusiness development">
  ...
  <link rel="icon" href="./pics/agrix.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" href="ourteamtz.css"> <!-- CSS dosyanızı buraya ekleyin -->
...
<div class="gallery">
	...
	<div class="gallery-item">
        <img src="./pics/monica.jpeg" alt="izmir psychologist">
        <div class="title">Founder & Managing Director: Irene Paul Mitema</div>
    </div>
	
		<div class="gallery-item">
        <img src="./pics/lisa.jpeg" alt="izmir psychologist">
        <div class="title">Co-founder & Public Relation Manager: Leah Mollel</div>
    </div>
	
    <div class="gallery-item">
        <img src="./pics/1.jpg" alt="izmir psychologist">
        <div class="title">Co-founder & Operation Manager: Dominica.E.Mlelwa</div>
    </div>
	
	<div class="gallery-item">
        <img src="./pics/14.jpg" alt="izmir psychologist">
        <div class="title">Marketing Officer: Neema L. Kamwela</div>
    </div>
	
	
	
	<div class="gallery-item">
        <img src="./pics/16.jpg" alt="izmir psychologist">
        <div class="title">Office Administrator: Happy D. Makerege</div>
    </div>
	
	
	
	<div class="gallery-item">
        <img src="./pics/18.jpg" alt="izmir psychologist">
        <div class="title">Marketing Officer: Innocent Tairo</div>
    </div>
	
	
    <div class="gallery-item">
        <img src="./pics/2.jpg" alt="izmir psychologist">
