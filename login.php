...
if (isset($email) && isset($password)) {
    ...
    if ($kayitsayisi > 0) {
        ...
        if (password_verify($password, $hashpassword)) {
            ...
            echo '<div class="alert alert-danger" role="alert">Nywila si sahihi.</div>'; 
        }
    } else {
        echo '<div class="alert alert-danger" role="alert">Barua pepe haipo kwenye mfumo. Tafadhali jisajili.</div>';
    }
}
}
...
@media (max-width: 600px) {
  ...
  <body>
    ...
    <div >
            <div style="display:flex;"><button type="submit" name="login" class="btn btn-primary">Ingia.</button>    
            <button style="margin-left:5px; margin-right:5px" type="submit" name="signnup" class="btn btn-primary">Jisajili.</button></div>
            <div><span style="font-size:15px; margin-top:10px;"><a href="forgot_password.php">Umesahau nywila?</a></span></div>
